...
api_key="AIzaSyCsH3un6oAuEo0ypY0s2NTKBuiqMPczlac"
...
myconnection = pymysql.connect(host="localhost", user='root', password='root', database='youtube_harvesting')
...
st.set_page_config(page_title="Youtube_harvesting_warehousing" , page_icon=":youtube:", layout="wide")

#header section


st.subheader("Hi, i am G SENTHIL KUMAR :smiley:")

# CREATING OPTION MENU
with st.sidebar:
    selected = option_menu(None, ["About Project","Data Collection & Migration Zone","Data Analysis Zone", "Q & A Zone"],
                           default_index=0,
...
if selected == "About Project":
    ...
    #Data Collection & Migration Zone
elif selected == "Data Collection & Migration Zone":
    ...
    with tab2:
        ...
        #myconnection = pymysql.connect(host="localhost",user='root',password='root')
...
#Data Analysis Zone                
if selected == "Data Analysis Zone":
    ...
    if Check_channel:
        ...
        engine = create_engine("mysql+pymysql://root:root@localhost/youtube_harvesting")
...
# Create a connection to SQL
    connect_for_question = pymysql.connect(host="localhost", user="root", passwd="root", port=3306, db="youtube_harvesting")
